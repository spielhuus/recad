mod tests {
    mod parser {
        ...
        use recad::{draw::{At, Label, Symbol, Wire}, gr::Pt, plot::{theme::{Theme, Themes}, Plotter, SvgPlotter}, schema::Junction, Drawer, Plot, Schema};
        fn init() {
        ...
        fn draw_schema() {
            ...
            let builder = Schema::new()
                ...
                .draw(Symbol::new("R2", "100k", "Device:R")
                    .anchor("1")
                    .tox("U1", "1"));
